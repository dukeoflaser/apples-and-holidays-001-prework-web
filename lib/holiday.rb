...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |season, festivals| 
    ...
    festivals.each do |festival, supplies|
      holiday_array = festival.to_s.split("_")
      holiday_caps = holiday_array.collect { |i| i.capitalize }
      holiday = holiday_caps.join(" ")
...
def all_holidays_with_bbq(holiday_hash)
  ...
  holiday_hash.each do |season, festivals |
    festivals.each  do |festival, supplies|
      bbq_holidays << festival if supplies.include?("BBQ")
    end  
  end
  bbq_holidays
end
